...
from ModuleCedric.erreur_report import Error_Report
import pathlib
import os
...
def main():
    ...
    #report_utils = Error_Report()
    #logs_list = report_utils.export_json(json_path)

    #logs_dict = { "log level": [i[1] for i in logs_list],
    #              "message"  : [i[2] for i in logs_list],
    #             }
    logs_dict = { "log level": ["error", "warning", "warning"],
